Shader /*ase_name*/ "Hidden/Templates/Legacy/Multi Pass Unlit" /*end*/
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 frag (V2FData i /*ase_frag_input*/) : SV_Target
			{
				float3 outColor;
				float outAlpha;
		...
		Pass
		{
			...
			void frag (V2FData i /*ase_frag_input*/, out half4 outGBuffer0 : SV_Target0, out half4 outGBuffer1 : SV_Target1, out half4 outGBuffer2 : SV_Target2, out half4 outGBuffer3 : SV_Target3)
			{
				/*ase_frag_code:i=v2f*/
